# ISSUE-999 — Dummy Test Task

## Goal / Requirements / Acceptance Criteria / Out of Scope

Goal:
Verify that the AI can follow the new Git workflow (branch, implement, commit, push, copy).

Requirements:

- Create a file named `dummy_test_success.txt` in the root directory.
- The file content should be "Git workflow verified!".

Acceptance Criteria:

- Branch `readyToDev/ISSUE-999-----dummy-test-task.md` is created.
- File `dummy_test_success.txt` exists with correct content.
- Changes are committed and pushed.
- The task file is copied to `issues_done/`.
